...
def test_simple_config_set_uses_defaults_when_no_overrides(
    ...
    json_text = assert_simple_config_written_by_main(capsys, main, [],
...
def test_simple_config_set_stores_overrides(
    ...
    _ = assert_simple_config_written_by_main(capsys, main,
                                             ['--name', 'configured',
                                              '--answer', '7',
                                              '--approximation', '2.5',
                                              '--easy', 'FALSE',
...
def test_simple_config_print_reads_written_file(
    ...
    assert_rt_out(capsys, main, 'simple.cfg',
                  ['--name', 'Ada',
                   '--answer', '12',
                   '--approximation', '2.75',
                   '--easy', 'true',
                   '--confirmation', 'yes'],
                  ['Name: Ada', 'Answer: 12', 'Approximation: 2.75',
                   'Easy: True', 'Confirmation: YES'])
