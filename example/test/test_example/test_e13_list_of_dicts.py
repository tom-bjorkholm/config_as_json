...
def test_e13_print_reports_outer_list_too_short(
    ...
    assert_print_validator_error(
        capsys, monkeypatch, E13_SPEC, {'maintenance_windows': []},
...
def test_e13_print_reports_outer_list_too_long(
    ...
    assert_print_validator_error(capsys, monkeypatch, E13_SPEC,
...
def test_e13_print_reports_missing_mandatory_window_key(
    ...
    assert_print_validator_error(
        capsys, monkeypatch, E13_SPEC,
        {'maintenance_windows': [{
            'name': 'weekend'
        }]}, [
            'maintenance_windows',
            "Mandatory key 'hours_utc'",
            'missing',
        ])
...
def test_e13_main_round_trip_prints_default_windows(
    ...
    assert_rt_out(capsys, e13_main, 'list_of_dicts.cfg', [], [
...
def test_e13_main_round_trip_with_json_cli_override(
    ...
    json_override = ('[{"name":"weekend","hours_utc":[10,11,12]},'
                     '{"name":"weekday","hours_utc":[8,9],"priority":2}]')
    assert_rt_out(
        capsys, e13_main, 'list_of_dicts.cfg',
