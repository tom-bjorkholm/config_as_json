...
E17_SPEC = ExampleProgramSpec(module=e17_module,
                              factory_name='ExampleConfig17',
...
def test_e16_print_reports_missing_step_key(
    ...
    assert_print_command_reports_validator_error(
        ...
        monkeypatch,
        E16_SPEC,
        e16_json_data(pipeline_steps=[{'name': 'extract'}]),
        ['pipeline_steps[0]', "Mandatory key 'enabled'", 'missing']
    )
...
def test_e16_print_reports_non_dict_step(
    ...
    assert_print_command_reports_validator_error(
        ...
        e16_json_data(pipeline_steps=[{'name': 'extract',
                                       'enabled': True}, 'load']),
        ['pipeline_steps[1]', 'type str', 'expected dict']
    )
...
def test_e17_print_reports_missing_csv_dialect_name(
    ...
    assert_print_command_reports_validator_error(
        ...
        ['csv_dialect', "Required key 'name' is missing"]
    )
