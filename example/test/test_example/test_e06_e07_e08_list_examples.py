...
from example.e07_list_order_vs_normalize import \
    e07_order_vs_normalize_print, e07_list_order_vs_normalize_set
...
from example.e08_combined_list_validators import (e08_combined_validators_print
                                                  )
...
E06_SPEC = ExampleProgramSpec(module=e06_module, factory_name='ExampleConfig6',
...
E07_SPEC = ExampleProgramSpec(module=e07_module, factory_name='ExampleConfig7',
                              config_factory=ExampleConfig7,
                              set_command=e07_list_order_vs_normalize_set,
                              print_command=e07_order_vs_normalize_print,
                              config_basename='list_order_vs_normalize.cfg')

E08_SPEC = ExampleProgramSpec(module=e08_module, factory_name='ExampleConfig8',
                              config_factory=ExampleConfig8,
                              set_command=e08_combined_list_validators_set,
                              print_command=e08_combined_validators_print,
...
def test_e06_report_formats_are_dynamic(capsys: pytest.CaptureFixture[str],
    ...
    set_values: SetValues = {'report_formats': ['pdf']}
    with TemporaryDirectory() as dirname:
        config_file = dirname + '/list_basic_validators.cfg'
        e06_list_basic_validators_set(set_values, config_file)
        config = ExampleConfig6(from_json_filename=config_file)
...
def test_e06_set_reports_invalid_report_format(
    ...
    assert_set_validator_error(capsys, monkeypatch, E06_SPEC,
...
def test_e06_print_reports_invalid_backup_server_count(
    ...
    assert_print_validator_error(capsys, monkeypatch, E06_SPEC,
                                 {
                                     'retry_delays_seconds': [1, 5, 10],
                                     'report_formats': ['json'],
                                     'backup_servers': []
...
def test_e06_main_round_trip_prints_list_values(
    ...
    assert_rt_out(capsys, e06_main, 'list_basic_validators.cfg',
                  [
...
def test_e07_set_reports_invalid_threshold_order(
    ...
    assert_set_validator_error(capsys, monkeypatch, E07_SPEC,
                               {'alert_thresholds': [0.8, 0.4]},
                               [
                                   'alert_thresholds',
                                   'less than previous value 0.8',
                               ])
...
def test_e07_print_reports_invalid_report_name_type(
    ...
    assert_print_validator_error(capsys, monkeypatch, E07_SPEC,
                                 {
                                     'alert_thresholds': [0.5, 0.75, 0.9],
...
def test_e07_main_round_trip_prints_checked_and_normalized_lists(
    ...
    assert_rt_out(capsys, e07_main, 'list_order_vs_normalize.cfg',
                  [
                      '--alert-thresholds',
                      '0.2',
                      '0.4',
...
def test_e08_set_checks_size_after_deduplication(
    ...
    assert_set_validator_error(capsys, monkeypatch, E08_SPEC,
                               {'run_hours_utc': [12, 12]},
...
def test_e08_print_reports_invalid_hour_before_normalization(
    ...
    assert_print_validator_error(capsys, monkeypatch, E08_SPEC,
                                 {'run_hours_utc': [4, 25]},
...
def test_e08_main_round_trip_prints_normalized_run_hours(
    ...
    assert_rt_out(capsys, e08_main, 'combined_list_validators.cfg',
